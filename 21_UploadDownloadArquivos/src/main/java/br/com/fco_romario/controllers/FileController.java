...
public class FileController implements FileControllerDocs {
    ...
    @Override
    public ResponseEntity<Resource> downloadFile(@PathVariable String fileName, HttpServletRequest request) {//HttpServletRequest é gerado pela própria requisição http
